...
- **תקופת התנסות:** 14 יום ללא עלות, ללא צורך בכרטיס אשראי בהתחלה.
- **לאחר 14 יום:** המשתמש מזין פרטי אשראי דרך מסך סליקה.
- **מחיר:** 47 ₪ לחודש. המפעיל הוא עוסק פטור — לא נגבה מע"מ ולא מצוין "כולל מע"מ" (יש להחזיר ניסוח מע"מ רק אם יהפוך לעוסק מורשה).
...
- "14 יום התנסות ללא עלות. אחר כך 47 ₪ לחודש — אפשר לבטל בלחיצה."
...
| כן | לא |
|----|-----|
| "14 יום התנסות ללא עלות" | "חודש חינם!" |
...
- שמירת מידע: נשמר כל עוד החשבון קיים / כל עוד רלוונטי; המשתמש יכול לבקש מחיקה בכל עת. אין מחיקה אוטומטית מתוזמנת.
